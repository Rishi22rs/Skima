    ...
    render() {
        ...
        <React.Fragment>
            <ul id="slide-out" className="sidenav sidenav-fixed" style={palette.background}>
                ...
                <div style={{ position: 'absolute', bottom: '60px', width: '100%' }}><li><a href={`/HeyWasup/themes/${localStorage.getItem('cookie')}`} className='waves-effect' style={palette.heading}><i className="material-icons" style={palette.heading}>exit_to_app</i>Logout</a></li></div>
            </ul>
            </React.Fragment>
        )
    };
