    ...
    render() {
        ...
        <React.Fragment>
            <ul id="slide-out" className="sidenav sidenav-fixed" style={palette.background}>
                ...
                <li onClick={()=>{localStorage.getItem('isGrades')==='true'?this.setActive('grades'):alert('Grades are not available for your department right now.')}}><Link to={localStorage.getItem('isGrades')==='true'?`/HeyWasup/grades`:`/HeyWasup/attendance`} className='waves-effect' style={palette.heading}><i className="material-icons" style={palette.heading}>grade</i>Grades</Link></li>
                ...
                <li onClick={()=>{localStorage.getItem('isGrades')==='true'?this.setActive('analytics'):alert('Analytics is not available for your department right now.')}}><Link to={localStorage.getItem('isGrades')==='true'?`/HeyWasup/analytics`:`/HeyWasup/attendance`} className='waves-effect' style={palette.heading}><i className="material-icons" style={palette.heading}>show_chart</i>Analytics</Link></li>
