    ...
    render() {
        ...
        <React.Fragment>
            <ul id="slide-out" className="sidenav sidenav-fixed" style={palette.background}>
                ...
                <li onClick={()=>this.setActive('attendance')} className='hide-on-med-and-down'><Link to={`/HeyWasup/attendance`} className='waves-effect' style={palette.heading}><i className="material-icons" style={palette.heading}>perm_identity</i>Attendance</Link></li>
                <li onClick={()=>this.setActive('home')} className='hide-on-med-and-down'><Link to={`/HeyWasup/timetable`} className='waves-effect' style={palette.heading}><i className="material-icons" style={palette.heading}>schedule</i>Timetable</Link></li>
                ...
                <li onClick={()=>this.setActive('planner')} className='hide-on-med-and-down'><Link to={`/HeyWasup/planner`} className='waves-effect' style={palette.heading}><i className="material-icons" style={palette.heading}>event</i>Planner</Link></li>
