    ...
    render() {
        ...
        <React.Fragment>
            <ul id="slide-out" className="sidenav sidenav-fixed" style={palette.background}>
                ...
                <li><a href={`/HeyWasup/${localStorage.getItem('cookie')}`} onClick={this.close} className='waves-effect' style={palette.heading}><i class="material-icons" style={palette.heading}>perm_identity</i>Attendance</a></li>
