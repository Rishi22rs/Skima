    ...
    render() {
        ...
        <React.Fragment>
            <ul id="slide-out" className="sidenav sidenav-fixed" style={palette.background}>
                ...
                <li onClick={()=>this.setActive('home')} className='hide-on-small-only'><Link to={`/HeyWasup`} className='waves-effect' style={palette.heading}><i className="material-icons" style={palette.heading}>schedule</i>Timetable</Link></li>
