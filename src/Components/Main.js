...
const BottomNav = () => {
    ...
    const [navTitle, setNavTitle] = useState('Timetable')
    ...
    return (
        <>
            ...
            <ul className="tabs tabs-a hide-on-med-and-up" style={Object(palette.background, palette.heading)}>
                ...
                <li className="tab"><a href="#test11" className='active' onClick={()=>setNavTitle('Timetable')} style={{paddingTop: '6px'}}><i className="material-icons" style={Object.assign(palette.heading)}>schedule</i></a></li>
                <li className="tab"><a href="#test12" onClick={()=>setNavTitle('Planner')} style={{paddingTop: '6px'}}><i className="material-icons" style={Object.assign(palette.heading)}>event</i></a></li>
            </ul>
